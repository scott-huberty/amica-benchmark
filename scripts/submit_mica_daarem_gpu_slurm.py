...
def main() -> None:
    ...
    parser.add_argument("--accelerator-start-iters", default="1,5,10,25")
    parser.add_argument("--accelerator-periods", default="1,2,5,10")
    parser.add_argument("--accelerator-eps-monotones", default="0")
    parser.add_argument("--accelerator-validate-candidates", default="true,false")
